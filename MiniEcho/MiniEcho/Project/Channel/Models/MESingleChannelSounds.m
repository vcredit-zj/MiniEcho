...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.likeCount = [self objectOrNilForKey:kMESingleChannelSoundsLikeCount fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.likeCount forKey:kMESingleChannelSoundsLikeCount];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.likeCount = [aDecoder decodeObjectForKey:kMESingleChannelSoundsLikeCount];
